...
def main():
    ...
    config_data['terraform_12_version'] = json.loads(dataworks_sensitive['SecretBinary'])["terraform_12_version"]
    config_data['terraform_13_version'] = json.loads(dataworks_sensitive['SecretBinary'])["terraform_13_version"]
